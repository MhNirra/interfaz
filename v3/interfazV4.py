...
root = ThemedTk(theme="breeze")  # Utilizar el tema "Breeze dark"
style = ttk.Style(root)  # Importar el objeto style
...
root.title("Sentiment and emotions analysis")
...
# Marco de carpetas
folders_frame = ttk.LabelFrame(left_frame, text="Carpetas")
folders_frame.pack(pady=10)

folders_label = ttk.Label(folders_frame, text="Seleccione una carpeta:")
folders_label.pack(pady=10)

folders_combo = ttk.Combobox(folders_frame, values=["Carpeta 1", "Carpeta 2", "Carpeta 3"], state="readonly")
folders_combo.pack()
...
style.configure("TCombobox", fieldbackground="#F5F5DC", foreground="#333") # Cambiar colores de Combobox
